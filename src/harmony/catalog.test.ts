...
const PINNED_IDS: string[] = [
  ...
  "ascending-fourths-cycle", "atmospheric-pad-loop", "augmented-line-rise", "autumn-leaves",
  "backdoor-amen-bvii-iv-i", "backdoor-cadence", "basic-channel-stab", "bii-biii-i-mystery",
  "bird-blues", "bird-turnaround", "bitcrush-bloom", "blue-hour",
  "broken-music-box", "call-response-stabs", "canon", "chain-reaction-i-iv",
  "chicago-warmth", "chilled-neurofunk", "chromatic-mediants", "chrome-bass",
  "chunky-funk-vamp", "climbing-buildup", "cold-descent", "cold-modal-loop",
  "cold-steel", "coltrane-ii-v-reharm", "cosmic-min9-pad", "cracked-bell",
  "creep", "dark-descent", "data-rot", "deep-chord-drift-i-bvi",
  "deep-house-lean", "deep-house-ninths", "deep-jazz-roller", "desolate-open-drone",
  "detroit-deep", "detroit-parallel-stabs", "diminished-bite", "diva-house",
  "doo-wop-i-vi-iv-v", "doom-riff", "dorian-cloud", "dorian-hope",
  "dorian-maj-iv-vamp", "dorian-sunrise-iv", "driftwood", "driving-i-bvi-vamp",
  "dub-skank", "dub-space-skank", "dusk-backdoor", "dystopian-pulse",
  "echo-chamber-i-v", "emotional-breakdown", "epic-8-bar-uplifter", "euphoric-vi-iv-i-v",
  "faded-photo", "floating-maj7-wash", "four-chord-iv-i-v-vi", "fractal-lullaby",
  "full-moon", "funky-breaks", "future-bass-lift", "garage-gospel",
  "ghetto-swing", "giant-steps-cycle", "glass-shards", "glitched-cadence",
  "golden-era-sus", "gospel-walk-up", "grid-pulse", "halftime-void",
  "hands-up-vi-iv-i-v-i", "harmonic-major-borrowed-iv", "harmonic-sting-v-i", "hendrix-sharp9-funk",
  "heroic-bvii-iv-i", "hollow-min7-pulse", "hollow-room", "hollywood-cadence",
  "horn-stab-groove", "hospital-rhodes", "hypnotic-i-bvi", "hypnotic-i-drone",
  "i-biii-iv-blues-rock", "i-iii-vi-iv", "i-iv-v-iv-loop", "i-v-iv-rock",
  "i-vi-ii-v-turnaround", "ii-v-of-iv", "ii-v-of-vi", "iii-vi-ii-v",
  "interstellar-oscillation", "iron-lung", "iv-v-i-cadence", "jackin-vamp",
  "jazz-blues", "jazz-stab-jungle", "jazzy-ii-v-i", "lady-bird-turnaround",
  "language-climb", "larry-heard", "liquid-ii-v-i", "liquid-ii-v-ladder",
  "liquid-soul-lift", "lo-fi-blues", "locrian-half-dim-drift", "long-short-vamp",
  "lush-garage-2-step", "lush-maj9-bed", "lush-maj9-vamp", "lydian-float",
  "lydian-sharp11-planing", "lydian-wonder-i-ii", "major-ii-v-i", "major-third-planing",
  "maurizio-i-bvii", "melancholy-sixths", "mellow-min6", "melodic-dubstep-yearn",
  "melodic-i-bvi-biii-bvii", "melodic-ii-v-i", "melodic-minor-tonic-vamp", "melodic-progressive-groove",
  "midnight-motor", "midnight-pulse", "min9-planing-chain", "minor-blues-12-bar",
  ...
  "neapolitan-cadence", "neo-gospel-descent", "neo-soul-lush-9ths", "neon-sunset",
  "neon-vamp", "night-bassline", "night-drive", "night-ritual",
  "nonlinear", "nostalgia-iii-vi", "nostalgic-maj7-arc", "ominous-half-step",
  "outrun-anthem", "parallel-glide", "passing-diminished", "peak-time-i-biii-bvii",
  "phrygian-bii-i", "phrygian-dust", "phrygian-loop-bii-i-bvii-bvi", "phrygian-tech",
  "pop-punk-power-four", "praise-break-cycle", "progressive-i-vi-iii-vii", "progressive-sweep",
  "quadrant-min9-haze", "quantize-error", "r-b-lean", "ragga-clash",
  "ragga-minor-vamp", "rainy-window", "rare-groove-skank", "reese-drone",
  "retro-cascade", "rhodes-cascade", "rhodes-shuffle", "rhythm-changes-bridge",
  "rising-iv-bvi-bvii-i", "rolling-i-bvi-bvii", "rolling-minor-vamp", "rotation-v-vi-iv-i",
  "royal-road", "satin-doll-ii-v-chain", "secondary-dom-turn", "sharp-iv-diminished",
  "shimmer-add9-wash", "shout-1-4-vamp", "silky-r-b-turn", "sine-wave-suspension",
  "singer-songwriter-i-iii-iv-v", "skippy-rhodes", "skywalker-mixolydian", "sliced-modal",
  "slow-rain", "smoke-vinyl", "so-what-cadence", "so-what-modal",
  "soulful-cascade", "soulful-piano-house", "soulful-planing", "spanish-circuit",
  "static-rush", "steppers-minor", "study-vamp", "stutter-drift",
  "submerged-i-iv-bvii", "sunday-chords", "sunrise-i-iv-vamp", "sunset-terrace",
  "sus-pump", "sus2-sneer", "sus2-sus4-pump", "sus4-breath",
  "suspended-drift", "suspended-fog", "suspended-pedal", "suspended-tension",
  "suspense-hit-rest", "tape-delay-i-biii", "three-chord-i-iv-v", "trance-sus-rise",
  "tritone-sub-2-5-1", "tritone-terror", "tritone-turnaround", "tritone-walkdown-2-5-1",
  "turnaround-loop", "twelve-bar-blues-quick-change", "twilight-liquid", "two-chord-groove",
  "two-step-lush", "uplift-i-bvii-bvi-bvii", "uplifting-minor-chorus", "velvet-six",
  "vhs-sunrise", "vocal-house", "vocoder-nights", "warehouse-i-bvii",
  "warehouse-sus", "warm-cassette", "warm-rhodes", "warm-static",
  "warp-dorian-vamp",
]
