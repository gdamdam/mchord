...
const SHELL_CACHE = 'mchord-shell-v1'
...
const RUNTIME_CACHE = 'mchord-runtime-v1'
const RUNTIME_MAX_ENTRIES = 64
const APP_BASE = new URL('./', self.location.href).pathname
const SHELL_URLS = [APP_BASE, `${APP_BASE}manifest.webmanifest`, `${APP_BASE}mchord-mark.svg`]
